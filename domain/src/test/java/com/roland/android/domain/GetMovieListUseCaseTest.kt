...
class GetMovieListUseCaseTest {
	...
	fun testProcess() = runTest {
		...
		whenever(movieRepository.fetchMoviesByGenre("")).thenReturn(flowOf(animeCollections))
		whenever(movieRepository.fetchMoviesByRegion("")).thenReturn(flowOf(bollywoodMovies))
		...
		whenever(tvShowRepository.fetchShowsByGenre("")).thenReturn(flowOf(animeShows))
		whenever(tvShowRepository.fetchShowsByRegion("")).thenReturn(flowOf(bollywoodShows))
